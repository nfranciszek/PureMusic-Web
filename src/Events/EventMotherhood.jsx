  ...
  return (
    <VStack w="full" spacing={4} p={4}>
      <Heading fontSize="20px" textAlign="center">
        Gentle Piano Sessions for Pregnant & New Mothers
      </Heading>
      ...
      <Text textAlign="center" fontSize="sm" color="gray.700">
        Weekdays: Tuesdays, Wednesdays, Thursdays — 12:00 PM (45 mins)
      </Text>

      <HStack color="gray.600">
              <MdLocationOn />
              <Text fontSize="12px">Mount Laurel, NJ</Text>
            </HStack>
        ...
        <Box bg="gray.700" p={4} rounded="md" w="full" maxW="600px" color="white">
          <VStack spacing={3}>
            ...
            <Text fontSize="14px" lineHeight="1.6" textAlign="center" px={6}>
              ...
              You’re welcome to sit in a chair or bring a blanket, mat, or pillow to lie back and fully relax. Come as you are—whether you're pregnant, postpartum, or simply seeking peace. Parents with babies or young children are warmly welcome. We create a nurturing space for all stages of motherhood and beyond.
            </Text>
          </VStack>
        </Box>
      )}
            ...
            <div
                ...
                data-url="https://calendly.com/nathanaelfra/gentle-piano-meditation-relaxation-for-mothers?hide_event_type_details=1&hide_gdpr_banner=1&primary_color=06e4ed"
...
export default EventMotherhood